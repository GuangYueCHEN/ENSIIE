...
int main(int argc, char **argv)
{
    ...
    /*res = inversion_videoNB(fich.bitmap, xsize, ysize, &xsize2, &ysize2);*/
    /* res = bruiteNB(fich.bitmap, xsize, ysize,1,&xsize2, &ysize2);*/
    /*res = fishEyeNB(fich.bitmap, xsize, ysize, &xsize2, &ysize2);*/
