...
public class SaveFile {
    ...
    public static void main(String argv[]) {
        ...
        try {
            ...
            // oInstance.addItem("http://www.javaweb.cc/网络编程001.zip","./网络编程1.zip");//
            // oInstance.addItem("http://www.javaweb.cc/网络编程002.zip","./网络编程2.zip");
            // oInstance.addItem("http://www.javaweb.cc/网络编程003.zip","./网络编程3.zip");
            // //开始下载
            // oInstance.downLoadByList();
            oInstance.saveToFile("http://www.javaweb.cc/网络编程001.zip",
                    "./down.zip");
        } catch (Exception err) {
