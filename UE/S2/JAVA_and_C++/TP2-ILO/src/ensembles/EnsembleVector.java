...
public class EnsembleVector<E> extends EnsembleGenerique<E> {
	 ...
	 * Ce qui revient dans le cas présent à ajouter un élément au vecteur si
	 ...
	 * vecteur sous-jacent plutôt que l'itérateur (amélioration de performances)
	 *
