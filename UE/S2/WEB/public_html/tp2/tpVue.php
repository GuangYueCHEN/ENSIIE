...
*/
    print "<br><a href=index.php> Menu </a><br>\n";
    print "<br><a href=tpQuitter.php>Quitter</a>\n";
...
/* type, value, name, label, id, (required), (step) */
...
*/
   echo '<form action="tpModifClient.php" method="post">'.
    ...
    '<label>Nom va changer:</label>'.
        ajout_champ('hidden', $numCli, 'numCli', '', '', 0).
       ajout_champ("text", $nomCli, 'nomCli', "", "", 0)."<br/>\n".
    '<label>débit va changer:</label>'.
    ajout_champ("number", $debitCli, "debitCli", "", "", 0)."<br/>\n".
	ajout_champ('submit', 'Envoyer', 'soumission', '', '', 0)."\n".
   '</form>';
...
*/
   echo '<form action="tpNvelAchat.php" method="post">'.
     ajout_champ('hidden', $numCli, 'numCli', '', '', 0).
     ajout_champ("number",NULL, "montant", "", "", 0)."<br/>\n".
  	ajout_champ('submit', 'Envoyer', 'soumission', '', '', 0)."\n".
       '</form>';
