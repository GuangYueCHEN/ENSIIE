...
*/
        ...
        $req1 = 'UPDATE client SET  debit_client = debit_client - \''.format_number(test_input($montant)).'\' WHERE num_client = '.test_input($numCli);
        $req2 = "INSERT INTO achat(montant_achat,client,date_achat) VALUES ( $montant,$name,current_date)";
